package com.example.chatopia.firebase;
...
import com.example.chatopia.activities.BaseActivity;
import com.example.chatopia.activities.ChatActivity;
...
public class MessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(@NonNull RemoteMessage message) {
        ...
        int notificatinId = new Random().nextInt();
        ...
        notificationManagerCompat.notify(notificatinId, builder.build());
    }
